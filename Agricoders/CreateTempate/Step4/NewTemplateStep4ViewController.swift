//
//  NewTemplateStep4ViewController.swift
//  Agricoders
//
...
class NewTemplateStep4ViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return templateStep4Object.count
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let model = templateStep4Object[indexPath.row]
    ...
    @objc func buttonDidTap() {
        let viewController = NewTemplateStep5ViewController()
